...
1. The temperature gets higher as it gets closer to the equator. This is proven by the linear regression analysis between Max Temp vs. Latitude. In Northern Hemisphere, temperature is negatively related to latitude while in Southern Hemisphere temperature is positively related to latitude.
2. All other factors- humidity, cloudiness and wind speeds have very low/no relationship with latitude.
3. Overall humidity in all selected cities is more intensely distributed within 60%-100%, cloudiness is evenly distributed between 0-100%, wind speed focus in the range between 0-15%.
